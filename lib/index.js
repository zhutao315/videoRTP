...
function handleError(error) {
  if (error.name === 'ConstraintNotSatisfiedError') {
    ...
    errorMsg(concat$2(_context = "The resolution ".concat(v.width.exact, "x")).call(_context, v.height.exact, " px is not supported by your device."));
...
function _openRTC() {
  _openRTC = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(element) {
    var stream;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 8:
            ...
            return _context2.abrupt("return", promise$3.reject(_context2.t0));
...
function CanvasRecord(video, cb) {
  ...
  var timer = null;
  var endFunc = null;
  var promise = new promise$3(function (resolve) {
...
function _pressVideo() {
  _pressVideo = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(videoFile, cb, options) {
    var video, record;
    return regenerator.wrap(function _callee$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            options && assign$2(config, options); // 自定义配置
          ...
          case 7:
            ...
            video.onloadedmetadata = function () {
              if (video.duration > config.MAXTIME) {
                ...
                throw new Error(concat$2(_context = "\u89C6\u9891\u65F6\u957F".concat(video.duration, "\u8D85\u8FC7")).call(_context, config.MAXTIME));
              }
            };
...
function _degrade() {
  _degrade = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(config) {
    var file, record;
...
function _openVideo() {
  _openVideo = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(config) {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 9:
            ...
            return _context2.abrupt("return", promise$3.reject({
          ...
          case 13:
            ...
            resolveP = null;
            promise = new promise$3(function (resolve) {
